...
public class DriverTourSpecification {
    ...
    public static Specification<ServiceRequest> inTimeRange(
        ...
        return (root, query, cb) -> {
            ...
            Join<ServiceRequest, AirportTransferDetail> detail = root
                    .join("tourBookingDetail", JoinType.INNER);
            ...
            if (startDate != null && endDate == null) {
                ...
                end = endDate.toLocalDate().plusDays(1).atStartOfDay();
            } else {
            ...
            return cb.and(
                    ...
                    cb.lessThan(detail.get("pickupDate"), end));
        };
    }
