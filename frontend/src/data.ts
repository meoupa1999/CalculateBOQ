...
export const BASE_INVENTORY: InventoryItem[] = [
  ...
  },
  {
    id: "item-rack-10u",
    code: "RACK-10U-F",
    name: "Tủ Rack 10U (Có bánh xe)",
    category: "Rack",
    spec: "Kích thước H500 x W600 x D500mm, Bánh xe di chuyển, Quạt hút, Khóa an toàn",
    unit: "Cái",
    basePrice: 1350000,
  },
  {
    id: "item-rack-20u",
    code: "RACK-20U-F",
    name: "Tủ Rack 20U (Có bánh xe)",
    category: "Rack",
    spec: "Kích thước H1000 x W600 x D600mm, Bánh xe di chuyển, Quạt hút, Khóa an toàn",
    unit: "Cái",
    basePrice: 2200000,
  },
  {
